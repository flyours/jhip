...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "jhipster1@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "jhipster1 API";

        private String description = "jhipster1 API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "jhipster1";
